...
bool GuiButton::Draw(Render* render)
{
	...
	case GuiControlState::NORMAL:
		render->DrawRectangle(bounds, 61, 190, 152, 255, true, false);
		break;
	case GuiControlState::FOCUSED:
		render->DrawRectangle(bounds, 66, 209, 204, 255, true, false);
		break;
	case GuiControlState::PRESSED:
		render->DrawRectangle(bounds, 61, 140, 249, 255, true, false);
		break;
	}
