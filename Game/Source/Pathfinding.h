...
public:
	...
	int CreatePath(const iPoint& origin, const iPoint& destination, bool flying);
	...
	bool IsWalkable(const iPoint& pos, bool flying) const;
...
struct PathNode
{
	...
	uint FindWalkableAdjacents(PathList& list_to_fill,bool fly) const;
